...
import { subscriptionStatusFilterOptions } from "@/lib/select-options";
import type {
  BillingOverview,
  BillingSubscription,
  PaginatedResult,
...
export default function PlatformBillingPage() {
  ...
  const { data: overview, isLoading: overviewLoading } = useQuery({
    ...
    queryFn: () => apiClient<BillingOverview>("platform/billing/overview"),
  });
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: () =>
      apiClient<PaginatedResult<BillingSubscription>>(
