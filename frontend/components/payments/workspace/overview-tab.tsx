...
import { FinancialSummaryCard } from "@/components/payments/financial-summary-card";
...
import type { PaymentsOverview } from "@/types/api";
...
export function PaymentsOverviewTab() {
  const { data, isLoading, isError, refetch } = useQuery({
    ...
    queryFn: () => apiClient<PaymentsOverview>("payments/overview"),
  });
