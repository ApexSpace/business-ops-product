...
import type { Invoice, PaginatedResult, Payment } from "@/types/api";
...
export function PaymentFormDialog({
  ...
  const mutation = useMutation({
    mutationFn: async (values: PaymentFormValues) => {
      ...
      if (isEdit && payment) {
        return apiClient<Payment>(`payments/${payment.id}`, {
          method: "PATCH",
          body,
        });
      }
      return apiClient<Payment>("payments", { method: "POST", body });
    },
    onSuccess: () => {
