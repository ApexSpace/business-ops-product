...
import type { CalendarFormValues } from "@/lib/calendar-profile";
import {
...
export function CalendarGoogleSyncPanel({
  ...
  const { data: syncStatus, isLoading: statusLoading } = useQuery({
    ...
    queryFn: () =>
      apiClient<GoogleCalendarSyncStatus>(`calendars/${calendarId}/sync/status`),
    enabled: Boolean(calendarId),
  });

  const syncMutation = useMutation({
    mutationFn: () =>
      apiClient<GoogleCalendarSyncSummary>(`calendars/${calendarId}/sync/google`, {
        method: "POST",
      }),
