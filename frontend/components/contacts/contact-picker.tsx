...
import { QuickCreateContactDialog } from "@/components/contacts/quick-create-contact-dialog";
...
export function ContactPicker({
  ...
  const { data: loadedContact } = useQuery({
    ...
    queryFn: () => apiClient<Contact>(`contacts/${value}`),
