  ...
  const composerBody = showWhatsAppTemplateComposer ? (
    ...
    <>
      ...
      <Textarea
        ...
        rows={variant === "thread" ? 1 : 2}
        className={
          variant === "thread"
            ? "min-h-9 flex-1 resize-none border-0 bg-transparent px-1 py-2 text-sm shadow-none focus-visible:ring-0"
        ...
        <div
          className={
            showWhatsAppTemplateComposer
              ? "space-y-2"
              : "flex items-end gap-2 rounded-lg border border-border/70 bg-background px-2 py-1.5 shadow-sm"
          }
        >
