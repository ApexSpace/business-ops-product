...
import { industryStatusFilterOptions } from "@/features/platform/utils/select-options";
...
function PlatformIndustriesPageContent() {
  ...
  const deleteMutation = useMutation({
    mutationFn: (id: string) => deletePlatformIndustry(id),
    onSuccess: () => {
...
export function PlatformIndustriesPage() {
  return (
