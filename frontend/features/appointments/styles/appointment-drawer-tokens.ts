...
export const APPOINTMENT_DRAWER_SHEET_CONTENT_CLASS =
  "overflow-visible border-0 !bg-transparent shadow-none backdrop-blur-none [background-image:none]";
...
/** Spine: 30px · Figma primary/500 · rounded left 12px only. */
export const APPOINTMENT_DRAWER_SPINE_CLASS =
...
export const APPOINTMENT_DRAWER_CLOSE_ACTION_CLASS =
  "!size-[22px] shrink-0 rounded-full !border-0 !bg-transparent p-0 text-muted-foreground !shadow-none hover:!bg-transparent hover:text-violet-primary-normal [&>svg]:size-[14px]";
...
export const APPOINTMENT_DRAWER_FOOTER_CLASS = cn(
  ...
  "border-t border-[#EEEAE6] bg-white px-4 py-4 sm:px-6",
  "sm:!flex-col !items-stretch !justify-start !gap-[15px]",
  "!border-[#EEEAE6] !bg-white !py-4 !px-4 sm:!px-6",
);
...
/** Figma Toggle — 40×17.5 · radius 62.5 · pad 1.25 · neutral/400 off. */
export const APPOINTMENT_DRAWER_SWITCH_CLASS = cn(
  "data-[size=default]:!h-[17.5px] data-[size=default]:!w-10 data-[size=default]:!rounded-full data-[size=default]:!p-[1.25px]",
...
export const APPOINTMENT_DRAWER_FIELD_CLASS =
  "h-11 min-h-11 w-full max-w-full rounded-[var(--radius-sm)] border border-[#D1D1D1] bg-white px-3 text-[14px] shadow-none focus-visible:border-violet-primary-normal focus-visible:ring-2 focus-visible:ring-violet-primary-normal/20 data-[size=default]:h-11 data-[size=sm]:h-11";

/** Overrides SelectTrigger glass-control so Time matches Date (Figma neutral/300 #D1D1D1). */
export const APPOINTMENT_DRAWER_SELECT_TRIGGER_CLASS = cn(
  APPOINTMENT_DRAWER_FIELD_CLASS,
  "!border-[#D1D1D1] !bg-white !backdrop-blur-none [background-image:none]",
...
export const APPOINTMENT_DRAWER_SERVICE_PICKER_CLASS =
  "z-50 w-[min(320px,calc(100vw-2rem))] overflow-hidden rounded-[var(--radius-sm)] border border-[#D1D1D1] bg-white p-0 shadow-[0_8px_24px_rgba(44,27,21,0.12)] ring-0";
...
export const APPOINTMENT_DRAWER_TYPE_TAB_INACTIVE_CLASS =
  "!h-full !rounded-[6px] !border-0 !bg-transparent !text-[14px] !font-semibold !text-[#3D3D3D] hover:!bg-white/50 data-active:!bg-transparent data-active:!text-[#3D3D3D] after:!opacity-0";

export const APPOINTMENT_DRAWER_BOOKING_DATETIME_ROW_CLASS =
  "grid w-full min-w-0 grid-cols-2 gap-4 max-[360px]:grid-cols-1";
