...
import { formatMoney, type EstimateFormValues } from "@/features/estimates/schemas/estimate-profile";
...
export function EstimateFormSummary({ form, totals }: EstimateFormSummaryProps) {
  return (
    <>
