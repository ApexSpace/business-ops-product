...
export const WORKSPACE_NAV_SECTION_TRIGGER_CLASS =
  "cursor-pointer px-2 py-2.5 text-sm font-semibold text-foreground hover:no-underline";

export const WORKSPACE_NAV_ITEM_CLASS =
  "flex min-h-[var(--control-height)] min-w-0 cursor-pointer items-center gap-2 rounded-[var(--radius-control)] px-3 py-2 text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring";
