...
import { GoogleCalendarSyncService } from '../../google-calendar-sync/google-calendar-sync.service';
...
export class AppointmentsService {
  ...
  async create(
    ...
    const sync = await this.googleCalendarSyncService.syncAppointmentToGoogle(
      businessId,
      appointment.id,
      actor.id,
    );
    ...
    return toAppointmentResponse(appointment, {
      googleSyncWarning: sync.warning,
    });
  }
