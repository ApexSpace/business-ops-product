...
export class OnlineBookingSettingsService {
  ...
  async updatePreferences(
    ...
    const settings = await this.repository.upsert(businessId, {
      ...
      expressBookingEnabled: dto.expressBookingEnabled,
      expressBookingAutoEnable: dto.expressBookingAutoEnable,
      expressBookingTimeLimitMinutes: dto.expressBookingTimeLimitMinutes,
