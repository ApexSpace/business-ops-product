...
import { OAUTH_STATE_TTL_MS } from '../constants/linkedin-oauth.constants';
...
export function createLinkedInOAuthState(
  payload: Omit<LinkedInOAuthStatePayload, 'nonce' | 'timestamp'>,
  secret: string,
): string {
  const fullPayload: LinkedInOAuthStatePayload = {
    ...payload,
