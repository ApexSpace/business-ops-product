...
export class EmailTemplateService {
  ...
  private buildSampleVariables(
    ...
    const samples: Record<string, string> = {
      ...
      'gift_card.number': '123456',
      'gift_card.balance': '$100.00',
      'gift_card.amount_paid': '$100.00',
      'gift_card.recipient_email': 'recipient@example.com',
      'gift_card.purchaser_name': 'Alex Buyer',
      'gift_card.recipient_name': 'Jane Recipient',
      'gift_card.promotion_name': 'Holiday special',
      'gift_card.promotion_description': 'Buy $100 get $100',
      'gift_card.disclaimer': 'Non-refundable.',
      'package.name': '5 Blowouts Package',
      'package.amount_paid': '$290.00',
      'package.total_qty': '5',
      'package.includes': '5 Blowout services',
      'package.expiration_date': 'December 31, 2026',
      'package.purchaser_name': 'Alex Buyer',
      'package.client_name': 'Jane Customer',
