...
const integrationProviders = [
  ...
  },
  {
    key: 'youtube',
    name: 'YouTube',
    description: 'Connect YouTube channels to schedule and upload videos from Social Planner.',
    category: 'SOCIAL_MEDIA',
    isPlatformLevel: false,
    isBusinessLevel: true,
    connectionType: 'OAUTH',
  ...
  },
  {
    key: 'x',
    name: 'X (Twitter)',
    description: 'Connect X accounts to schedule tweets from Social Planner.',
    category: 'SOCIAL_MEDIA',
    isPlatformLevel: false,
    isBusinessLevel: true,
    connectionType: 'OAUTH',
  ...
  },
  {
    key: 'pinterest',
    name: 'Pinterest',
    description: 'Connect Pinterest Business to schedule pins from Social Planner.',
    category: 'SOCIAL_MEDIA',
    isPlatformLevel: false,
    isBusinessLevel: true,
    connectionType: 'OAUTH',
  ...
  },
  {
    key: 'tiktok',
    name: 'TikTok',
    description: 'Connect TikTok to publish videos from Social Planner.',
    category: 'SOCIAL_MEDIA',
    isPlatformLevel: false,
    isBusinessLevel: true,
    connectionType: 'OAUTH',
